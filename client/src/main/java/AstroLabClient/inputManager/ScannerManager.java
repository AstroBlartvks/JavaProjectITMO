...
/**
 * The {@code ScannerManager} class manages the {@link Scanner}
 * instances used for reading input from various sources.
 * It provides functionality to switch between reading from the
 * console and reading from a file. The class also allows
 * saving and restoring the current {@code Scanner} state.
 *
 * <p>
 * The class utilizes {@link lombok.Getter} and {@link lombok.Setter}
 * annotations for the {@code fileScanner} property
