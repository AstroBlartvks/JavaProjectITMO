package AstroLabClient.clientCommand.scriptHandler;

import AstroLabClient.inputManager.ScannerManager;
import AstroLabClient.inputManager.SmartScanner;
import AstroLabClient.inputManager.SmartScannerType;
import java.io.File;
...
public class ScriptExecutes {
     ...
     * @throws ScriptExecuteScannerException If the script file
     *      does not exist, is unreadable, or recursion is detected.
     */
