...
public class ServerHelp extends ServerCommand {
    ...
    public ServerResponse execute(Action args) {
        String text = "help: \n" +
                      ...
                      "info: \n" +
                      "\toutput information about the collection (type, initialization date," +
                      " number of elements, etc.) to the standard output stream\n" +
                      "show: \n" +
                      "\toutput all elements of the collection in a string representation" +
                      ...
                      "add_if_min {element}: \n" +
                      "\tadd a new element to the collection if its value is less than " +
                      "that of the smallest element in this collection\n" +
                      "remove_greater {element}: \n" +
                      "\tremove from the collection all elements exceeding the specified limit\n" +
                      "count_by_distance distance: \n" +
                      "\toutput the number of elements whose value of the distance " +
                      "field is equal to the specified one\n" +
                      "count_greater_than_distance distance: \n" +
                      "\toutput the number of elements whose value of the distance " +
                      "field is greater than the specified one\n" +
